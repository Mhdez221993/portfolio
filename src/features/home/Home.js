      ...
      <div class="overlap-group-container-1">
        ...
        <div class="overlap-group14">
          <div class="intro-portfolio-about-contact">
            <span class="span0">Intro<br /></span><span class="span1">Portfolio<br />About<br />Contact</span>
          </div>
        </div>
      </div>
      <div class="flex-col">
        ...
        <div class="group-container-1">
          <div class="group-37">
            ...
            <p class="java-script-es5es6-ruby-html-cssroboto-normal-storm-gray-16px">
              JavaScript (ES5/ES6)&nbsp;&nbsp;&nbsp;&nbsp; Ruby<br />HTML<br />CSS
            </p>
          </div>
          <div class="overlap-group9">
            <div class="frameworks roboto-bold-scarpa-flow-22px">Frameworks</div>
            <div class="bootstrap-ruby-on-raroboto-normal-storm-gray-16px">
              Bootstrap<br />Ruby on Rails<br />RSpec<br />Capybara<br />Selenium
            </div>
          </div>
          <div class="overlap-group10">
            <div class="skills roboto-bold-scarpa-flow-22px">Skills</div>
            <div class="bootstrap-bulma-coderoboto-normal-storm-gray-16px">
              Bootstrap<br />Bulma<br />Codekit<br />Codepen<br />Github<br />Gitlab
            </div>
          </div>
        </div>
        <div class="overlap-group13">
          <img alt="Damy data" class="footer-shape" src="footer-shape.svg" />
          <div class="group-13">
