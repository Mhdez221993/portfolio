  ...
  return (
    <div className="skills">
      ...
      <div className="skill">
        ...
        <div className="languages roboto-normal-storm-gray-16px">Boostrap</div>
        <div className="languages roboto-normal-storm-gray-16px">Git</div>
        <div className="languages roboto-normal-storm-gray-16px">CI/CD</div>
        <div className="languages roboto-normal-storm-gray-16px">GitFlow</div>
      </div>
    </div>
  );
}
